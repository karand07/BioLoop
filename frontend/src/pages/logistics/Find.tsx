  ...
  if (isAvailableLoading) {
    return (
      <div className="flex flex-col items-center justify-center py-32 space-y-4">
        ...
        <p className="text-slate-500 font-bold uppercase tracking-widest text-[10px]">{t('scanning_shipments')}</p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-10 animate-in fade-in duration-700 pb-20">
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
        <div>
          <h1 className="text-4xl font-black text-slate-900 tracking-tight">{t('marketplace')}</h1>
          <p className="text-slate-500 font-medium">{t('new_opportunities')}</p>
        </div>
        ...
        <div className="flex items-center gap-4">
           <div className="relative group">
              ...
              <input 
                type="text" 
                placeholder={t('search_location_cargo')}
                value={search}
      ...
      {filteredPickups.length === 0 ? (
        <div className="bg-white p-20 rounded-[3rem] border border-dashed border-slate-200 text-center flex flex-col items-center justify-center space-y-4">
          ...
          <p className="text-xl font-bold text-slate-900">{t('no_matching_shipments')}</p>
        </div>
      ) : (
               ...
               <div className="p-8">
                  <div className="flex items-center justify-between mb-8">
                     ...
                     <div className="flex flex-col items-end">
                        ...
                        <p className="text-[10px] text-slate-400 font-bold uppercase tracking-widest">{t('estimated_payout')}</p>
                     </div>
                  </div>
                  ...
                  <div className="space-y-2 mb-8">
                     ...
                     <p className="text-[10px] text-slate-400 font-black uppercase tracking-[0.2em]">{pickup.order?.quantity} MT {t('weight')}</p>
                  </div>
                  ...
                  <div className="space-y-6 mb-10 relative">
                     ...
                     <div className="flex items-start gap-4 relative">
                        ...
                        <div>
                           <p className="text-[10px] text-slate-400 font-black uppercase tracking-widest mb-0.5">{t('origin')}</p>
                     ...
                     <div className="flex items-start gap-4 relative">
                        ...
                        <div>
                           <p className="text-[10px] text-slate-400 font-black uppercase tracking-widest mb-0.5">{t('destination')}</p>
      ...
      <div className="bg-white rounded-[3rem] p-10 border border-slate-100 flex flex-col md:flex-row items-center gap-10">
         ...
         <div className="flex-1 text-center md:text-left">
            <h3 className="text-xl font-black text-slate-900 tracking-tight mb-1">{t('peak_hours')}</h3>
            <p className="text-slate-500 font-medium max-w-lg">{t('peak_hours_desc')}</p>
         </div>
